...
This project is a **training-based E-Commerce Web API** built using **ASP.NET Core** and **Onion Architecture** to demonstrate clean architecture principles, modular design, and real-world backend functionality.

---

## 🚀 Features

- 🧾 **Order Module** – Manage customer orders and order items.  
